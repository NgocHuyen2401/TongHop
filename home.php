    ...
    <?php include('top_navbar.php'); ?>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
              ...
              <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-6 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><b><span>Total</b><br>Events</span>
                      <div class="progress">
          ...
          </section> <!-- Kết thúc Dashboard Counts Section -->

<!-- Flight Schedule Section -->
<section class="flight-schedule no-padding-top">
    <div class="container-fluid">
        <div class="row bg-white has-shadow">
            <div class="col-12">
                <h3 class="h4">Lịch Trình Chuyến Bay</h3>
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $flight_query = $conn->query("SELECT * FROM flight_schedule") or die(mysql_error());
                        while ($flight_row = $flight_query->fetch()) {
                        ?>
                        <tr>
                            <td><?php echo $flight_row['flight_code']; ?></td>
                            <td><?php echo $flight_row['departure_time']; ?></td>
                            <td><?php echo $flight_row['gate_number']; ?></td>
                            <td><?php echo $flight_row['destination']; ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
...
<hr /> <!-- Giữ nguyên dòng này để tách biệt với phần Projects Section -->
